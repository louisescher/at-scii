...
let object: THREE.Mesh, plane: THREE.Mesh;
...
const PARAMS = {
  ...
  invert: true,
  object: 'sphere', // sphere, box, torus, cone, cylinder
  background: '#000000',
};
...
function init() {
  ...
  // 1. Resolution, default 0.15 (number)
  // 2. Scale, default 1 (number)
  // 3. Choice between color or gradient, default color (select)
  // 4. Color, default #ffffff (color picker)
  // 5. Gradient, default null (double color picker)
  // 6. alpha, default 1 (number)
  // 7. invert, default false (boolean)
  // 8. strResolution, default low (select)
  ...
  // 1. Scene background color, default #000000 (color picker)
  // 2. Object
}
...
function render() {
  ...
  // sphere.rotation.z = Math.sin( timer * 0.002 ) * 0.3;
  // sphere.rotation.y = Math.sin( timer * 0.002 ) * 0.3;
  // sphere.rotation.x = Math.sin( timer * 0.002 ) * 0.3;
